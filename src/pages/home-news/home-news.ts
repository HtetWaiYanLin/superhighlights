...
import {HomeNewsDetailPage} from "../home-news-detail/home-news-detail";
...
export class HomeNewsPage {
 ...
 // @ViewChild(Slides) slides: Slides;
  ...
  openPlaylist(ydata) {
    this.app.getRootNav().push(HomeNewsDetailPage, {
      data:ydata,
    });
  ...
  getVideoData(): Observable<any> {
    // this.isLoading=true;
    const first = firebase.firestore().collection('news_data')
